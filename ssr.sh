...
Add_iptables(){
		iptables -I INPUT -m state --state NEW -m tcp -p tcp --dport 8445:9543 -j ACCEPT
		iptables -I INPUT -m state --state NEW -m udp -p udp --dport 8445:9543 -j ACCEPT
}
Save_iptables(){
if [[ ${OS} == "centos" ]]; then
...
Start_SSR(){
	check_pid
	wget -O /etc/init.d/ssrmu "https://github.com/wehoi/ws/raw/main/ssrmu"
...
Install_SSR
wget -O /usr/bin/more https://github.com/wehoi/ws/raw/main/ssrmu.sh && chmod +x /usr/bin/more
wget -O /usr/bin/ssr https://github.com/wehoi/ws/raw/main/add-ssr.sh && chmod +x /usr/bin/ssr
wget -O /usr/bin/ssrd https://github.com/wehoi/ws/raw/main/del-ssr.sh && chmod +x /usr/bin/ssrd
wget -O /usr/bin/ssrr https://github.com/wehoi/ws/raw/main/renew-ssr.sh && chmod +x /usr/bin/ssrr

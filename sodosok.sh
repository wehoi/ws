#!/bin/bash
#shadowsocks-libev obfs install by jAvaNet
...
cd /usr/bin
wget -O ss "https://github.com/wehoi/ws/raw/main/add-ss.sh"
wget -O sd "https://github.com/wehoi/ws/raw/main/del-ss.sh"
wget -O sc "https://github.com/wehoi/ws/raw/main/cek-ss.sh"
wget -O sr "https://github.com/wehoi/ws/raw/main/renew-ss.sh"
chmod +x ss
chmod +x sd
chmod +x sc
chmod +x sr

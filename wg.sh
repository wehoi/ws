...
echo -e "${Info} Wireguard VPS AutoScript by jAvaNet"
...
# Tambahan
cd /usr/bin
wget -O wg "https://github.com/wehoi/ws/raw/main/add-wg.sh"
wget -O wgd "https://github.com/wehoi/ws/raw/main/del-wg.sh"
wget -O wgc "https://github.com/wehoi/ws/raw/main/cek-wg.sh"
wget -O wgr "https://github.com/wehoi/ws/raw/main/renew-wg.sh"
chmod +x wg
chmod +x wgd
chmod +x wgc
chmod +x wgr
